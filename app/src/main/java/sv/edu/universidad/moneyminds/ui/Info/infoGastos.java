...
public class infoGastos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout  binding = (LinearLayout) inflater.inflate(R.layout.fragment_info_gastos, null);
        ...
        mcV = binding.findViewById(R.id.crdGa);
